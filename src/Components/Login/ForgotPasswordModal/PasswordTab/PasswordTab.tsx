...
const AuthCodeSvg = () => (
    <svg focusable="false" data-prefix="fas" data-icon="fingerprint"
         className="svg-inline--fa fa-fingerprint fa-w-16" role="img"
         viewBox="0 0 512 512">
...
export const PasswordTab = (props: IProps): JSX.Element => {
    ...
    const changeAccountPassword = async (values: IPasswordSchema, actions: FormikActions<IPasswordSchema>) => {
        try {
                        ...
                        >
                            ...
                            >
                                <Input
                                    ...
                                    prefix={<AuthCodeIcon style={{width: "15px"}}/>}
                                />
                            </Form.Item>
                        </Tab>
                    </Form>
